...
public:
	enum Options{
		...
		VIDEO_BUFFER_OPT = 9,
		VIDEO_RESOLUTION_X_OPT = 10,
		VIDEO_RESOLUTION_Y_OPT = 11,
		VIDEO_RESOLUTION_ASP_OPT = 12,
		VIDEO_RESOLUTION_NAME_OPT = 13,
		VIDEO_FFPRESET_PREFIX_OPT = 14,
		VIDEO_FFPRESET_PATH_OPT = 15,
		VIDEO_FFPRESET_TYPE_OPT = 16,
		//
		AUDIO_MODE_OPT = 17,
		AUDIO_FORMAT_OPT = 18,
		AUDIO_ENCODER_OPT = 19,
		AUDIO_GRADE_TYPE_OPT = 20,
		AUDIO_GRADE_VALUE_OPT = 21,
		AUDIO_SAMPLERATE_OPT = 22,
		AUDIO_CHANNEL_VALUE_OPT = 23,
		AUDIO_CHANNEL_NAME_OPT = 24,
		//
		END_OPT = 25,
		//
		MANUAL_COMMAND_OPT = 26,
		MANUAL_ARG_OPT = 27,
		UNKNOWN_OPT = 28
	};
public:
