...
private:
	enum State{
		START, METADATA, DURATION, END, INVALID_DATA, FILE_NOT_FOUND, SCANNER_ERROR
	};
public:
	enum ScanResult{
		OK_RESULT, INVALID_DATA_RESULT, FILE_NOT_FOUND_RESULT, OTHER_RESULT, SCANNER_ERROR_RESULT
	};
public:
